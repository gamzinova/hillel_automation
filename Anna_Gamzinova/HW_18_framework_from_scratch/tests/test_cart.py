...
def test_item_in_the_cart(open_main_page):
    ...
    assert cart_page.is_first_item_in_the_cart() is True, "The item has not been added"
...
def test_remove_item_from_cart(open_cart_page_with_item):
    ...
    assert cart_page.is_first_item_in_the_cart() is False, "The item has not been removed"
...
def test_continue_shopping(init_main_page, open_cart_page_with_item):
    ...
    assert main_page.is_products_banner() is True, "You haven't been forwarded to the main page"
...
def test_checkout(open_cart_page_with_item):
    ...
    assert checkout_page.is_first_name_info() is True, "User has not been forwarded to checkout page"
...
def test_set_values_and_continue(open_checkout_page):
    ...
    assert overview_page.is_payment_information() is True, "User has not been forwarded to overview page"
...
def test_empty_checkout_info_error(open_checkout_page):
    ...
    assert checkout_page.is_error_message_checkout() is True, "User was able to checkout"
